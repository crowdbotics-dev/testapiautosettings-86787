...
## Project Structure
    ...
    ├── testapiautosettings_86787  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_86787`
...
2. Clone this repo and `cd testapiautosettings_86787`
